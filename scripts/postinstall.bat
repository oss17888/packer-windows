...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://github.com/lightkeeper/lswindows-lib/blob/master/amd64/python/PIL-1.1.7.win-amd64-py2.7.exe?raw=true', 'C:\Users\vagrant\PIL117.exe')"
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/robotframework-autoitlibrary/AutoItLibrary-1.1.zip', 'C:\Users\vagrant\AutoItLibrary-1.1.zip')"
cmd /c "C:\Program Files\7-Zip\7z.exe" x "C:\Users\vagrant\AutoItLibrary-1.1.zip" -o"C:\Users\vagrant"
