...
powershell -Command "choco install vcredist2015 -y"
powershell -Command "choco install dotnet-4.6.2 -y"
...
# powershell -Command "choco install python2-x86_32 -y"   Install Fail
...
powershell -Command "choco install visualstudio2015community -y"
powershell -Command "choco upgrade visualstudio2015community -y"