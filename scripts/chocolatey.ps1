...
powershell -Command "choco install rapidminer -y"
...
powershell -Command "choco install nexus-oss -y"
powershell -Command "choco install docker-for-windows -y"
